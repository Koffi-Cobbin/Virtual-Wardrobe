            ...
            <div>
              <Sheet>
                <SheetTrigger asChild>
                  <Button variant="ghost" className="hover:opacity-80 transition-opacity p-0 h-14 w-14 flex items-center justify-center bg-transparent border-none min-h-[56px] min-w-[56px]">
                    <svg 
                      width="56" 
                      height="56" 
                      viewBox="0 0 24 24" 
